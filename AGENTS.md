...
This project is indexed by GitNexus as **slides_agent** (3177 symbols, 5895 relationships, 223 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
