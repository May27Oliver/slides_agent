...
This project is indexed by GitNexus as **slides_agent** (6998 symbols, 12826 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
