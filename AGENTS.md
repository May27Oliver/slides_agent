...
This project is indexed by GitNexus as **slides_agent** (4601 symbols, 8417 relationships, 272 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
