...
This project is indexed by GitNexus as **slides_agent** (4379 symbols, 8059 relationships, 260 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
