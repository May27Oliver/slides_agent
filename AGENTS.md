...
This project is indexed by GitNexus as **slides_agent** (3381 symbols, 6340 relationships, 218 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
