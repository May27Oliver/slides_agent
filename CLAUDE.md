...
This project is indexed by GitNexus as **slides_agent** (5445 symbols, 9960 relationships, 297 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
