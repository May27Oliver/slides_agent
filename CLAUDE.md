...
This project is indexed by GitNexus as **slides_agent** (7147 symbols, 13027 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
